<h1 id="join-us" style="text-align: center; font-size: 36px; margin-bottom: 20px; color: #2f95de;">Join Us</h1>

<div style="font-size: 18px; line-height: 1.8; color: #333; max-width: 800px; margin: 0 auto;">
  <p style="font-size: 22px; font-weight: bold;">Postdoc and Ph.D. Opportunities in Climate-Smart Agriculture at Virginia Tech</p>
  <p>
  ...
  <!-- Position 1 -->
  <h3 style="font-size: 20px; color: #2f95de; margin-top: 30px;">Position 1: Postdoctoral Researcher (AI-Driven Climate-Smart Agriculture)</h3>
  <p>
  ...
  <!-- Position 2 -->
  <h3 style="font-size: 20px; color: #2f95de; margin-top: 30px;">Position 2: Ph.D. Student (Agricultural Carbon Systems)</h3>
  <p>
